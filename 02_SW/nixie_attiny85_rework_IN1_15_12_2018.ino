...
void DispTime() 
{
  if(counter == 100)
  {counter = 0;}
  int hourdigit1 =counter/10;//(now.hour())/10;
  int hourdigit2 =counter%10;//(now.hour())%10;
  int mindigit1 =counter/10;//(now.minute())/10;
  int mindigit2 =counter%10;//(now.minute())%10;
  int secdigit1 =counter/10;//(now.second())/10;
  int secdigit2 =counter%10;//(now.second())%10;
