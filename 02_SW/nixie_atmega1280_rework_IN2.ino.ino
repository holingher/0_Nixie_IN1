...
void DispTime() 
{
  int hourdigit1 =1;//(now.hour())/10;
  int hourdigit2 =2;//(now.hour())%10;
  int mindigit1 =3;//(now.minute())/10;
  int mindigit2 =4;//(now.minute())%10;
  int secdigit1 =5;//(now.second())/10;
  int secdigit2 =6;//(now.second())%10;
